...
Kod (proste) linearne regresije, parametar $b_1$ se interpretira kao "za koliko se promeni $Y$ ako se $X$ promeni za 1 jedinicu mere". Kod logističke regresije je situacija nešto kompleksnija, jer imamo logističku transformaciju.
